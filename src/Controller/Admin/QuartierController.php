...
use App\Form\Admin\QuartierType;
...
{
    /**
     * @Route("/", name="admin_quartier_index", methods={"GET"})
     */
    public function index(QuartierRepository $quartierRepository): Response
    {
        return $this->render('admin/quartier/index.html.twig', [
            'quartiers' => $quartierRepository->findAll(),
        ]);
    }

    /**
     * @Route("/new", name="admin_quartier_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="admin_quartier_show", methods={"GET"})
     */
    public function show(Quartier $quartier): Response
    {
        return $this->render('admin/quartier/show.html.twig', [
            'quartier' => $quartier,
        ]);
    }

    /**
     * @Route("/{id}/edit", name="admin_quartier_edit", methods={"GET","POST"})
     */
    public function edit(Request $request, Quartier $quartier): Response
    {
        ...
        return $this->render('admin/quartier/edit.html.twig', [
            'quartier' => $quartier,
            'form' => $form->createView(),
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="admin_quartier_delete", methods={"DELETE"})
     */
